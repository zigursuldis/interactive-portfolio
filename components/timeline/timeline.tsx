...
export default function Timeline() {
  ...
  return (
    <section>
      <div className="flex flex-col items-center justify-between h-[300px] lg:h-[400px] bg-bg-secondary mt-10">
      ...
      <div className="flex justify-center items-center opacity-75 text-sm mt-1">
